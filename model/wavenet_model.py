...
class WaveNetModel(nn.Module):
    ...
    def __init__(self, hparams, device):
        ...
        self.start_pad = nn.ConstantPad1d((self.initial_kernel-1, 0), 0)
    ...
    def wavenet(self, input, condition):
        ...
        input = self.start_pad(input)   #左边填充0
        ...
        for i in range(self.blocks * self.layers - 1):
            ...
            filter, gate = torch.chunk(dilated, 2, dim=1)   # torch.cat的操作
    ...
    def generate(self, conditions, cat_input=None):
        ...
        num_samples = conditions.shape[1]   #获取维度长度
